...
\newtcbtheorem[auto counter, crefname = {definition}{definition}, Crefname = {Definition}{Definition}]{df}{Definition}{
    sharp corners, colback = lightgray!40, colframe = darkgray, breakable, fonttitle = \bfseries
}{df}
...
\include{journals/atomsjournal}
\include{journals/rainsjournal}

\part{Report}
\label{part:report}

\include{reports/preliminaries}
